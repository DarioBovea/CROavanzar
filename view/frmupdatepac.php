<?php
    ...
    $stmt = $conn->prepare("SELECT * FROM pacientes WHERE id_pac=$id_pac");
    $stmt->execute();
...
<body>
    <div class="caja_popup2">
        <div  class="contenedor_popup2" id="formupdatepac">
            <form method="POST" class="form_modificar" id="formModificar"  action="../controller/updatepac.php?cod=<?php echo $id_pac ?>">
                <table>
                    <tr> 
                    ...
                    <!-- <tr> 
                            ...
                            <tr> 
                                <td>Rol</td>
                                <td><input type="text" name="rol" value="<?php ?>"required></td>
                            </tr> -->
                    <tr style="text-align: center">
                        <td colspan="2">
                            <a class="form_btn" id="btn_mod_cancelar" href="../view/pacientes.php">Cancelar</a>
