...
<body>
        ...
        <articule class="tablas">
            ...
            <table>
                ...
                <tr>
                    ...
                    <th colspan="2">
                        <button class="btn_agregar" onclick="abrirformagr()">Agregar </button>
                    </th>
                </tr>
                <tr>
                    <th>Tipo Doc</th>
                ...
                <?php
                    ...
                    $stmt = $conn->prepare("SELECT * FROM pacientes WHERE rol=3");
                    $stmt->execute();
                ...
                <?php
                    ...
                    echo " <td>" . $mostrar['fec_nac'] . "</td>";
                    echo " <td>" . $mostrar['email'] . "</td>";
                    echo " <td>" . $mostrar['dir'] . "</td>";
                    echo " <td>" . $mostrar['tel'] . "</td>";
                    echo " <td style='text-align: center'><a href=\"frmupdatepac.php?cod=$mostrar[id_pac]\"><i class='fa-solid fa-pen-to-square' style='color: #098897' aria-hidden='true'></i></a> | <a href=\"../controller/deletepac.php?cod=$mostrar[id_pac] \" onClick=\"return confirm('Estas seguro de eliminar a $mostrar[pri_nom] $mostrar[pri_ape]')\"><i class='fa fa-trash' style='color: #098897' aria-hidden='true'></i></a></td>";
                ?>
                </tr>
                <?php
                    }
    ...
    <div class="caja_popup" id="formregistrar">
        <?php
            include 'partial\frmpacientes.php';
        ?>
    </div>
