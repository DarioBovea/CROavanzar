<div class="contenedor_popup">
    <form class="form_registrar" id="form_registrar" action="../controller/nuevoregistro.php" method="post">
        <div class="cont_reg">
    ...
    <button class="form_btn" id="btn_reg" type="submit" form="form_registrar">Crear Usuario</button>
    <a class="form_btn" id="btn_mod_cancelar" href="../index.php">Cancelar</a>
</div>
